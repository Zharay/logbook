    ...
    private static final Map<String, ShipInfoDto> SHIP = new ConcurrentHashMap<String, ShipInfoDto>() {
        {
            ...
            this.put("118", new ShipInfoDto("Ooi Kai 2", "CLT", "Ooi", 0, 55, 25));
            this.put("119", new ShipInfoDto("Kitakami Kai 2", "CLT", "Kitakami", 0, 55, 25));
            ...
            this.put("137", new ShipInfoDto("Agano", "CL", "Agano", 35, 45, 30));
            this.put("138", new ShipInfoDto("Noshiro", "CL", "Noshiro", 35, 45, 30));
            this.put("139", new ShipInfoDto("Yahagi", "CL", "Yahagi", 35, 45, 30));
            ...
            this.put("149", new ShipInfoDto("Kongou Kai 2", "BB", "Kongou", 0, 135, 110));
            this.put("150", new ShipInfoDto("Hiei Kai 2", "BB", "Hiei", 0, 135, 110));
            ...
            this.put("223", new ShipInfoDto("Jintsuu Kai", "CL", "Jintsuu", 0, 30, 25));
            this.put("224", new ShipInfoDto("Naka Kai", "CL", "Naka", 0, 30, 25));
            ...
            this.put("267", new ShipInfoDto("Ashigara Kai", "CA", "あしがら", 0, 70, 40));
            this.put("268", new ShipInfoDto("Haguro Kai", "CA", "はぐろ", 0, 70, 40));
            this.put("269", new ShipInfoDto("Takao Kai", "CA", "たかお", 0, 70, 40));
            this.put("270", new ShipInfoDto("Atago Kai", "CA", "あたご", 0, 70, 40));
            this.put("271", new ShipInfoDto("Maya Kai", "CA", "まや", 0, 70, 40));
            this.put("272", new ShipInfoDto("Choukai Kai", "CA", "ちょうかい", 0, 70, 40));
            this.put("273", new ShipInfoDto("Tone Kai", "CA", "とね", 0, 65, 45));
            this.put("274", new ShipInfoDto("Chikuma Kai", "CA", "ちくま", 0, 65, 45));
            this.put("275", new ShipInfoDto("Nagato Kai", "BB", "ながと", 0, 160, 100));
            this.put("276", new ShipInfoDto("Mutsu Kai", "BB", "むつ", 0, 160, 100));
            this.put("277", new ShipInfoDto("Akagi Kai", "CV", "あかぎ", 0, 75, 75));
            this.put("278", new ShipInfoDto("Kaga Kai", "CV", "かが", 0, 80, 80));
            this.put("279", new ShipInfoDto("Souryuu Kai", "CV", "そうりゅう", 0, 65, 65));
            this.put("280", new ShipInfoDto("Hiryuu Kai", "CV", "ひりゅう", 0, 65, 65));
            this.put("281", new ShipInfoDto("Ryuujou Kai", "CVL", "りゅうじょう", 0, 40, 40));
            this.put("282", new ShipInfoDto("Shouhou Kai", "CVL", "しょうほう", 0, 40, 40));
            this.put("283", new ShipInfoDto("Hiyou Kai", "CVL", "ひよう", 0, 45, 45));
            this.put("284", new ShipInfoDto("Junyou Kai", "CVL", "じゅんよう", 0, 45, 45));
            this.put("285", new ShipInfoDto("Houshou Kai", "CVL", "ほうしょう", 0, 30, 30));
            this.put("286", new ShipInfoDto("Fusou Kai", "BBV", "ふそう", 0, 105, 95));
            this.put("287", new ShipInfoDto("Yamashiro Kai", "BBV", "やましろ", 0, 105, 95));
            this.put("288", new ShipInfoDto("Shoukaku Kai", "CV", "しょうかく", 0, 70, 65));
            this.put("289", new ShipInfoDto("Kinu Kai", "CL", "きぬ", 0, 35, 25));
            this.put("290", new ShipInfoDto("Abukuma Kai", "CL", "あぶくま", 0, 35, 25));
            this.put("291", new ShipInfoDto("Chitose CVL Kai", "CVL", "ちとせ", 50, 40, 45));
            this.put("292", new ShipInfoDto("Chiyoda CVL Kai", "CVL", "ちよだ", 50, 40, 45));
            this.put("293", new ShipInfoDto("Yuubari Kai", "CL", "ゆうばり", 0, 40, 25));
            this.put("294", new ShipInfoDto("Maikaze Kai", "DD", "まいかぜ", 0, 20, 15));
            this.put("295", new ShipInfoDto("Kinugasa Kai", "CA", "きぬがさ", 55, 60, 35));
            this.put("296", new ShipInfoDto("Chitose CVL Kai2", "CVL", "ちとせ", 0, 40, 45));
            this.put("297", new ShipInfoDto("Chiyoda CVL Kai2", "CVL", "ちよだ", 0, 40, 45));
            this.put("298", ShipInfoDto.EMPTY);
            this.put("299", ShipInfoDto.EMPTY);
            this.put("300", new ShipInfoDto("Hatsukaze Kai", "DD", "はつかぜ", 0, 20, 15));
            this.put("301", new ShipInfoDto("Akigumo Kai", "DD", "あきぐも", 0, 20, 15));
            this.put("302", new ShipInfoDto("Yuugumo Kai", "DD", "ゆうぐも", 0, 20, 15));
            this.put("303", new ShipInfoDto("Makigumo Kai", "DD", "まきぐも", 0, 20, 15));
            this.put("304", new ShipInfoDto("Naganami Kai", "DD", "ながなみ", 0, 20, 15));
            this.put("305", new ShipInfoDto("Agano Kai", "CL", "あがの", 0, 50, 35));
            this.put("306", new ShipInfoDto("Noshiro Kai", "CL", "のしろ", 0, 50, 35));
            this.put("307", new ShipInfoDto("Yahagi Kai", "CL", "やはぎ", 0, 50, 35));
