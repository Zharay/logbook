    ...
    private static final Map<String, ShipInfoDto> SHIP = new ConcurrentHashMap<String, ShipInfoDto>() {
        {
            ...
            this.put("118", new ShipInfoDto("大井改二", "重雷装巡洋艦", "おおい", 0, 55, 25));
            this.put("119", new ShipInfoDto("北上改二", "重雷装巡洋艦", "きたかみ", 0, 55, 25));
            ...
            this.put("137", new ShipInfoDto("阿賀野", "軽巡洋艦", "あがの", 35, 45, 30));
            this.put("138", new ShipInfoDto("能代", "軽巡洋艦", "のしろ", 35, 45, 30));
            this.put("139", new ShipInfoDto("矢矧", "軽巡洋艦", "やはぎ", 35, 45, 30));
            ...
            this.put("149", new ShipInfoDto("金剛改二", "戦艦", "こんごう", 0, 135, 110));
            this.put("150", new ShipInfoDto("比叡改二", "戦艦", "ひえい", 0, 135, 110));
            ...
            this.put("181", new ShipInfoDto("イオナ", "潜水艦", "アルいおな", 0, 150, 150));
            this.put("182", new ShipInfoDto("タカオ", "重巡洋艦", "アルたかお", 0, 200, 175));
            ...
            this.put("212", new ShipInfoDto("霧島改", "戦艦", "きりしま", 0, 120, 90));
            ...
            this.put("223", new ShipInfoDto("神通改", "軽巡洋艦", "じんつう", 0, 30, 25));
            this.put("224", new ShipInfoDto("那珂改", "軽巡洋艦", "なか", 0, 30, 25));
            ...
            this.put("273", new ShipInfoDto("利根改", "重巡洋艦", "とね", 0, 65, 45));
            this.put("274", new ShipInfoDto("筑摩改", "重巡洋艦", "ちくま", 0, 65, 45));
            ...
            this.put("305", new ShipInfoDto("阿賀野改", "軽巡洋艦", "あがの", 0, 50, 35));
            this.put("306", new ShipInfoDto("能代改", "軽巡洋艦", "のしろ", 0, 50, 35));
            this.put("307", new ShipInfoDto("矢矧改", "軽巡洋艦", "やはぎ", 0, 50, 35));
