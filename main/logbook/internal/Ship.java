    ...
    private static final Map<String, ShipInfoDto> SHIP = new ConcurrentHashMap<String, ShipInfoDto>() {
        {
            ...
            this.put("172", new ShipInfoDto("Bismarck改", "戦艦", "ビスマルク", 0, 115, 95));
            ...
            this.put("310", new ShipInfoDto("Z1改", "駆逐艦", "レーベレヒト・マース", 0, 25, 20));
            this.put("311", new ShipInfoDto("Z3改", "駆逐艦", "マックス・シュルツ", 0, 25, 20));
